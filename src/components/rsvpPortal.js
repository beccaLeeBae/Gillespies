...
class RsvpPortal extends Component {
	...
	// 				Kindly reply on or before August 31.<br />
	// 				<small>
	// 					If you are RSVPing for multiple guests or a family, please add all
	// 					first names of guests in the First Name field.
	// 				</small>
	// 			</p>
	// 			<form onSubmit={e => this.props.sendRsvp(e)}>
	// 				<div className="row">
	...
	// 					</label>
	// 				</div>
	// 				<button onClick={e => this.props.sendRsvp(e)} className="mini-button">
	// 					RSVP
	// 				</button>
	// 			</form>
	// 		</div>
